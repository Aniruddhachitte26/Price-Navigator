 ...
 * @author divyansjemni
 */
public class ManageSupermarketAccountsJPanel extends javax.swing.JPanel {
    ...
    public ManageSupermarketAccountsJPanel(Business bz, JPanel jp) {
...
//clear supplier table
 int rc = UserAccountTable.getRowCount();
    ...
    for (UserAccount ua : uad.getUserAccountList()) {
        ...
        if (ua.getRole().equalsIgnoreCase("SuperMarket")) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Manage Supermarkets Accounts");
        add(jLabel2);
        jLabel2.setBounds(1, 20, 630, 28);
        ...
        add(btnRefresh);
        btnRefresh.setBounds(320, 300, 138, 24);
