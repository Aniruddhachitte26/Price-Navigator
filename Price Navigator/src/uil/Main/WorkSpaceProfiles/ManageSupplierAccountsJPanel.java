 ...
 * @author divyansjemni
 */
public class ManageSupplierAccountsJPanel extends javax.swing.JPanel {
    ...
    public ManageSupplierAccountsJPanel(Business bz, JPanel jp) {
...
//clear supplier table
 int rc = UserAccountTable.getRowCount();
    ...
    for (UserAccount ua : uad.getUserAccountList()) {
        ...
        if (ua.getRole().equalsIgnoreCase("supplier")) {
    ...
    private void initComponents() {
        ...
        add(jLabel2);
        jLabel2.setBounds(21, 20, 610, 30);
