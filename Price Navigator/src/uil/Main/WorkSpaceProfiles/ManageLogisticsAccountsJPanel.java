 ...
 * @author divyansjemni
 */
public class ManageLogisticsAccountsJPanel extends javax.swing.JPanel {
    ...
    public ManageLogisticsAccountsJPanel(Business bz, JPanel jp) {
...
//clear supplier table
 int rc = UserAccountTable.getRowCount();
    ...
    for (UserAccount ua : uad.getUserAccountList()) {
        ...
        if (ua.getRole().equalsIgnoreCase("LogisticPartnerUser")) {
    ...
    private void initComponents() {
        ...
        add(Next);
        Next.setBounds(500, 300, 90, 24);

        jLabel1.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 204, 255));
        jLabel1.setText("User Accounts");
        add(jLabel1);
        jLabel1.setBounds(30, 90, 140, 18);

        jLabel2.setFont(new java.awt.Font("Helvetica Neue", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 204, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Manage Logistics Accounts");
        add(jLabel2);
        jLabel2.setBounds(11, 20, 610, 30);
        ...
        add(btnRefresh);
        btnRefresh.setBounds(290, 300, 150, 24);
