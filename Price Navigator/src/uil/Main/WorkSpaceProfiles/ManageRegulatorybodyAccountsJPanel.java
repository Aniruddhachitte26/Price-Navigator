 ...
 * @author divyansjemni
 */
public class ManageRegulatorybodyAccountsJPanel extends javax.swing.JPanel {
    ...
    public ManageRegulatorybodyAccountsJPanel(Business bz, JPanel jp) {
...
//clear supplier table
 int rc = UserAccountTable.getRowCount();
    ...
    for (UserAccount ua : uad.getUserAccountList()) {
        ...
        if (ua.getRole().equalsIgnoreCase("RegulatoryBodyUser")) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Manage RegulatoryBody Accounts");
        add(jLabel2);
        jLabel2.setBounds(21, 20, 620, 30);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(30, 120, 550, 130);
        ...
        btnRefresh.setText("REFRESHDATA");
