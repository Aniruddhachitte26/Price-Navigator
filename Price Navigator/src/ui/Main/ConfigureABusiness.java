...
// We are create person objects to represent customer organizations. 
        ...
        Person customer1 = persondirectory.newPerson("Walmart","Walmart", "josephjoshi218@gmail.com", " ", " ", 0);

        Person customer2 = persondirectory.newPerson("BestBuy","BestBuy", "josephjoshi218@gmail.com", " ", " ", 0);

        Person customer3 = persondirectory.newPerson("Target","Target", "josephjoshi218@gmail.com", " ", " ", 0);

        Person customer4 = persondirectory.newPerson("Amazon","Amazon", "josephjoshi218@gmail.com", " ", " ", 0);

        Person customer5 = persondirectory.newPerson("Flipkart","Flipkart", "josephjoshi218@gmail.com", " ", " ", 0);

        Person customer6 = persondirectory.newPerson("Shaws","Shaws", "josephjoshi218@gmail.com", " ", " ", 0);

        Person customer7 = persondirectory.newPerson("Costco","Costco", "josephjoshi218@gmail.com", " ", " ", 0);

        Person customer8 = persondirectory.newPerson("Big Y","Big Y", "josephjoshi218@gmail.com", " ", " ", 0);

        Person customer9 = persondirectory.newPerson("Stop&Shop","Stop&Shop", "josephjoshi218@gmail.com", " ", " ", 0);

        Person customer10 = persondirectory.newPerson("IKEA","IKEA", "josephjoshi218@gmail.com", " ", " ", 0);
...
Person regularUser1 = persondirectory.newPerson("John","John", "josephjoshi218@gmail.com", "Massachusetts", "Male", 29);
